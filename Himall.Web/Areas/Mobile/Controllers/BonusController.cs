    ...
    public class BonusController : BaseMobileTemplatesController
    {
        ...
        public ActionResult Index(long id)
        {
            ...
            if (string.IsNullOrEmpty(item))
            {
                ...
                string authorizeUrl = Senparc.Weixin.MP.AdvancedAPIs.OAuthApi.GetAuthorizeUrl(_siteSetting.WeixinAppId.Trim(), absoluteUri, "123321#wechat_redirect", OAuthScope.snsapi_base, "code");
