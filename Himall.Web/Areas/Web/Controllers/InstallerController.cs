...
namespace Himall.Web.Areas.Web.Controllers
{
	public class InstallerController : Controller
	{
		...
		private bool CreateAdministrator(out string errorMsg)
		{
			...
			try
			{
				...
				using (mySqlConnection)
				{
					...
					dbCommand.CommandText = "SELECT Id FROM Himall_Shops limit 1";
					...
					dbCommand.Parameters.Add(new MySqlParameter("@shopId", num));
					dbCommand.Parameters.Add(new MySqlParameter("@userName", _shopAdminName));
					dbCommand.Parameters.Add(new MySqlParameter("@Password", passwrodWithTwiceEncode1));
					dbCommand.Parameters.Add(new MySqlParameter("@PasswordSalt", str1));
					dbCommand.Parameters.Add(new MySqlParameter("@CreateDate", DateTime.Now));
					...
					dbCommand.Parameters.Add(new MySqlParameter("@userName", _siteAdminName));
					dbCommand.Parameters.Add(new MySqlParameter("@Password", passwrodWithTwiceEncode));
					dbCommand.Parameters.Add(new MySqlParameter("@PasswordSalt", str));
					dbCommand.Parameters.Add(new MySqlParameter("@CreateDate", DateTime.Now));
					dbCommand.ExecuteNonQuery();
					dbCommand.Parameters.Clear();
					dbCommand.CommandText = "INSERT INTO Himall_Members  (UserName, Password, PasswordSalt,TopRegionId,RegionId,OrderNumber,Disabled,Points,Expenditure,CreateDate,LastLoginDate)VALUES (@userName, @Password, @PasswordSalt,0,0,0,0,0,0.00,@CreateDate,@LastLoginDate )";
					dbCommand.Parameters.Add(new MySqlParameter("@userName", _shopAdminName));
					dbCommand.Parameters.Add(new MySqlParameter("@Password", passwrodWithTwiceEncode1));
					dbCommand.Parameters.Add(new MySqlParameter("@PasswordSalt", str1));
					dbCommand.Parameters.Add(new MySqlParameter("@CreateDate", DateTime.Now));
					dbCommand.Parameters.Add(new MySqlParameter("@LastLoginDate", DateTime.Now));
					dbCommand.ExecuteNonQuery();
					dbCommand.Parameters.Clear();
					dbCommand.CommandText = "update Himall_SiteSettings set Value=@SiteName WHERE  `Key`='SiteName'";
					dbCommand.Parameters.Add(new MySqlParameter("@SiteName", _siteName));
					dbCommand.ExecuteNonQuery();
		...
		private bool CreateDtabase(out string msg)
		{
			...
			using (DbConnection mySqlConnection = new MySqlConnection(str))
			{
				msg = "";
		...
		private string GetEFConnectionString()
		{
			...
			objArray[3] = _dbPwd;
			objArray[4] = _dbName;
			return string.Format("metadata=res://*/Entities.csdl|res://*/Entities.ssdl|res://*/Entities.msl;provider=MySql.Data.MySqlClient;provider connection string=\" server={0}{1};user id={2};password={3};persistsecurityinfo=True;database={4}\";", objArray);
		}
		...
		private bool UpdateSliderImage(out string errorMsg)
		{
			...
			try
			{
				...
				using (mySqlConnection)
				{
					...
					dbCommand.Parameters.Add(new MySqlParameter("@ImageUrl", "http://fpoimg.com/295x192"));
					dbCommand.ExecuteScalar();
					dbCommand.Parameters.Clear();
					dbCommand.CommandText = "update Himall_ImageAds set ImageUrl=@ImageUrl WHERE  `Id`=1";
					dbCommand.Parameters.Add(new MySqlParameter("@ImageUrl", "http://fpoimg.com/310x70"));
					dbCommand.ExecuteScalar();
					dbCommand.Parameters.Clear();
					dbCommand.CommandText = "update Himall_ImageAds set ImageUrl=@ImageUrl WHERE  `Id`=13";
					dbCommand.Parameters.Add(new MySqlParameter("@ImageUrl", "http://fpoimg.com/310x165"));
					dbCommand.ExecuteScalar();
					dbTransaction.Commit();
					dbConnection.Close();
				}
