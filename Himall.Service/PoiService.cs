...
namespace Himall.Service
{
	public class PoiService : ServiceBase, IPoiService, IService, IDisposable
	{
		...
		{
			WxJsonResult wxJsonResult = Senparc.Weixin.MP.AdvancedAPIs.PoiApi.DeletePoi(_accessToken, poiId, 10000);
		...
		{
			var category = Senparc.Weixin.MP.AdvancedAPIs.PoiApi.GetCategory(_accessToken);
		...
		{
			GetStoreResultJson poi = Senparc.Weixin.MP.AdvancedAPIs.PoiApi.GetPoi(_accessToken, poiId, 10000);
		...
		public GetStoreListResultJson GetPoiList(int page, int rows)
		{
			...
			GetStoreListResultJson poiList = Senparc.Weixin.MP.AdvancedAPIs.PoiApi.GetPoiList(_accessToken, num, rows, 10000);
		...
		{
			GetStoreListResultJson poiList = Senparc.Weixin.MP.AdvancedAPIs.PoiApi.GetPoiList(_accessToken, 0, 50, 10000);
		...
		{
			UploadImageResultJson uploadImageResultJson = Senparc.Weixin.MP.AdvancedAPIs.PoiApi.UploadImage(_accessToken, filePath, 10000);
